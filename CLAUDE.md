...
## No shared test/lint/build tooling
...
- `projects/snapsite-website/server`: manually exercise `POST /api/draft-report` after `npm start`; there's no test suite.
